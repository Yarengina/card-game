/******/ (() => {
    ...
    var getRandomCards = function (sourceArray, neededCards) {
        var result = [];
    ...
    var cardData = [
        ...
        {
            imgSrc: ''.concat(imgSrc, '/Ace-Diamonds.png'),
            name: 'Ace-Diamonds',
        },
        ...
        {
            imgSrc: ''.concat(imgSrc, '/Jack-Diamonds.png'),
            name: 'Jack-Diamonds',
        },
        ...
        {
            imgSrc: ''.concat(imgSrc, '/King-Diamonds.png'),
            name: 'King-Diamonds',
        },
        ...
        {
            imgSrc: ''.concat(imgSrc, '/Queen-Diamonds.png'),
            name: 'Queen-Diamonds',
        },
        {
            imgSrc: ''.concat(imgSrc, '/Queen-Hearts.png'),
            name: 'Queen-Hearts',
        },
        {
            imgSrc: ''.concat(imgSrc, '/Queen-Spades.png'),
            name: 'Queen-Spades',
        },
        ...
        randomData.forEach(function (item) {
            ...
            card.addEventListener('click', function () {
                ...
                if (window.application.cards.length === 2) {
                    if (
                        window.application.cards[0] !==
                        window.application.cards[1]
                    ) {
                        stopTime();
